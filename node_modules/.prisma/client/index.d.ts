...
export namespace Prisma {
  ...
  */
  ...
  export interface PaisesDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
     ...
     * 
     * // Only select the `id`
     * const paisesWithIdOnly = await prisma.paises.findMany({ select: { id: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Paises and only return the `id`
     * const paisesWithIdOnly = await prisma.paises.createManyAndReturn({ 
     *   select: { id: true },
     *   data: [
     *     // ... provide data here
     *   ]
  ...
  interface PaisesFieldRefs {
    readonly id: FieldRef<"Paises", 'String'>
    readonly nome: FieldRef<"Paises", 'String'>
    readonly continente: FieldRef<"Paises", 'String'>
    readonly populacao: FieldRef<"Paises", 'String'>
    readonly idh: FieldRef<"Paises", 'Float'>
  }
  ...
  export type PaisesWhereInput = {
    ...
    id?: StringFilter<"Paises"> | string
    nome?: StringFilter<"Paises"> | string
    continente?: StringFilter<"Paises"> | string
    populacao?: StringFilter<"Paises"> | string
    idh?: FloatFilter<"Paises"> | number
  }
  ...
  export type PaisesScalarWhereWithAggregatesInput = {
    ...
    id?: StringWithAggregatesFilter<"Paises"> | string
    nome?: StringWithAggregatesFilter<"Paises"> | string
    continente?: StringWithAggregatesFilter<"Paises"> | string
    populacao?: StringWithAggregatesFilter<"Paises"> | string
    idh?: FloatWithAggregatesFilter<"Paises"> | number
  }
  ...
  export type PaisesUpdateInput = {
    ...
    populacao?: StringFieldUpdateOperationsInput | string
    idh?: FloatFieldUpdateOperationsInput | number
  }
